  ...
  return (
    <div className="font-body-md text-ink-charcoal min-h-screen flex bg-paper-surface selection:bg-lacquer-red selection:text-white">
      ...
      <div className="md:ml-64 flex-1 flex flex-col h-full overflow-hidden">
        ...
        <SystemHealthHeader title="Cryptographic Audit Ledger & Chain Integrity" />

        <main className="flex-1 p-margin-desktop overflow-y-auto w-full custom-scrollbar">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-gutter">
            
            {/* Chain Integrity Status Card */}
            <div className="col-span-1 md:col-span-12 bg-surface-container-lowest border border-outline-variant rounded-xl p-6 flex flex-col sm:flex-row items-center justify-between mb-4 shadow-sm">
